...
public class MainActivity extends Activity implements OnClickListener, OnInitListener {
	...
	public void onClick(View v) {
		...
		case R.id.button1:
			if (!(isAccessibilityEnabled && isExploreByTouchEnabled)) {
				...
				if (isNeustartClicked == 1) {
					convertTextToSpeech("M�chten Sie das Spiel neustarten?");
				}
		...
		case R.id.button2:
			isNeustartClicked = 0;
			convertTextToSpeech("Men� wird aufgerufen");
	...
	private void checkIfGameIsWon() {
		...
		if (gameIsWon) {
			convertTextToSpeech("Gl�ckwunsch! Sie haben alle Paare gefunden.");
		}
	}
